...
*  c) Click the (Toggle DATA Step Debugger) button to     *;
*     enable debugging in the program. Click on the       *;
...
*     initial values?                                     *;
*  e) Click to execute the highlighted SET statement.     *;
...
*     of the DATA step?                                   *;
*  f) Click to step through the remaining statements in   *;
*     the DATA step. Which statements are executable?     *;
